# -*- coding: utf-8 -*-
"""
Problem definition for a single-point optimization of the 38 DV case.
...
def define_problem() -> OptimizationConfig:
    """Defines the 38 DV optimization problem."""
    print("--- Defining 38 DV Optimization Problem ---")
    
    model_name = "38_DV_Model"
    ...
    user_initial_point = torch.zeros(1, 38, device=DEVICE, dtype=DTYPE)
    ...
    problem_config = OptimizationConfig(
        ...
        n_initial_samples=50,  # At least as many as dimensions
        n_bo_iterations=300,
        batch_size=1,
...
# python main.py --problem src.problem_def_38dvs 